...
function calculateGridCellLayout() {
    ...
    if (placeholderElement && placeholderElement.parentElement) { placeholderElement.style.height = `${cellHeight}px`; placeholderElement.style.width = `${cellWidth}px`; }
 }
